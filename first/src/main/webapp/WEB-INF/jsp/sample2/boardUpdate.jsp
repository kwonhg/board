...
<body>
    ...
    <script type="text/javascript">
        ...
        function fn_openBoardList(){
            ...
            comSubmit.setUrl("<c:url value='/sample2/openBoardList.do' />");
            comSubmit.submit();
        }
         
        function fn_updateBoard(){
            var comSubmit = new ComSubmit("frm");
            comSubmit.setUrl("<c:url value='/sample2/updateBoard.do' />");
            comSubmit.submit();
        }
         
        function fn_deleteBoard(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/sample2/deleteBoard.do' />");
